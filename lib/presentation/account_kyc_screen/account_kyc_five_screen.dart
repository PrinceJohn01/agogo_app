...
class AccountKycFiveScreen extends StatelessWidget {
  const AccountKycFiveScreen({Key? key}) : super(key: key);
  ...
  onTapSubmit(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.paymentModalInstallmentPlanApprovalScreen);
  }
