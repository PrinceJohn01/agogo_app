...
class AgogoResetPasswordFourScreen extends StatelessWidget {
  const AgogoResetPasswordFourScreen({Key? key}) : super(key: key);
                      ...
                      child: Container(
                          ...
                          child: Column(children: [
                            ...
                            CustomElevatedButton(
                                ...
                                margin: EdgeInsets.only(
                                    left: 20.h, top: 62.v, right: 20.h),
                                buttonStyle: CustomButtonStyles.fillPrimary,
                                onTap: () {
                                  onTapSubmitpin(context);
                                }),
                            const Spacer(),
                            Container(
                                height: 68.v,
  ...
  onTapTxtResendlink(BuildContext context) {
  ...
  onTapSubmitpin(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.agogoResetPasswordOneScreen);
  }
}
