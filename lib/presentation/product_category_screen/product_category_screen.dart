...
import '../product_category_screen/widgets/productmodal8_item_widget.dart';
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                            ...
                            Expanded(
                                child: Container(
                                    ...
                                    child: Row(children: [
                                      CustomImageView(
                                          svgPath:
                                              ImageConstant.imgIcactionssearch,
                                          height: 16.adaptSize,
                                          width: 16.adaptSize,
                                          margin: EdgeInsets.symmetric(
                                              vertical: 4.v)),
                                      CustomImageView(
                                          svgPath: ImageConstant.imgFrame158,
                                          height: 24.v,
                                          width: 1.h,
                                          margin: EdgeInsets.only(left: 5.h)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              left: 7.h, top: 4.v, bottom: 4.v),
                                          child: Text(
                      ...
                      Padding(
                          padding: EdgeInsets.only(left: 8.h, top: 12.v),
                          child: Row(children: [
                            CustomImageView(
                                ...
                                child: RichText(
                                    text: TextSpan(children: [
                                      TextSpan(
                                          text: "lbl_promo".tr,
                                          style: CustomTextStyles
                                              .titleSmallSoraBlack900),
                                      TextSpan(
                                          text: "lbl_products".tr,
                                          style: CustomTextStyles
                                              .titleSmallSoraRed800)
                                    ]),
                          ...
                          child: Padding(
                              ...
                              child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Productmodal8ItemWidget(
                                        onTapProductmodal: () {
