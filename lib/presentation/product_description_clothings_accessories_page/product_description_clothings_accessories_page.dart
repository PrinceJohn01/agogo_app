import '../product_description_clothings_accessories_page/widgets/productprofile2_item_widget.dart';
...
class ProductDescriptionClothingsAccessoriesPage extends StatefulWidget {
  const ProductDescriptionClothingsAccessoriesPage({Key? key})
      : super(
          key: key,
        );

  @override
  ProductDescriptionClothingsAccessoriesPageState createState() =>
      ProductDescriptionClothingsAccessoriesPageState();
}

class ProductDescriptionClothingsAccessoriesPageState
    extends State<ProductDescriptionClothingsAccessoriesPage>
    with
        AutomaticKeepAliveClientMixin<
            ProductDescriptionClothingsAccessoriesPage> {
                                ...
                                child: Container(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      return const Productprofile2ItemWidget();
                                    },
                                  ),
                                ),
                              ),
